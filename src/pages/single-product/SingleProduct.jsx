            ...
            <article className="entry mb-0">
              ...
              <div className="entry__article-wrap">
                ...
                <div className="entry__article">
                  ...
                  <p><strong>Think about it:</strong> If you make one additional ask per day and convert at around 10 percent. Then you have three people each month providing you with benefits that youd have missed otherwise Its essential to make sure that your ask relates to some direct path to what you want, whether it is revenue, a business relationship or anything else of prime importance to you.</p>
...
>                    <div className="final-review__score">
                    ...
                    <div className="final-review__text-holder">
                      ...
                      <p className="final-review__text">Lovingly rendered real-world space tech,playing through actual missions is a special thrill,scoring system gives much needed additional incentive to perfect your designs</p>
                    </div>
                  </div> 
              ...
              <div className="entry-author clearfix">
                ...
                <div className="entry-author__info">
                  ...
                  <p className="mb-0">But unfortunately for most of us our role as gardener has never been explained to us. And in misunderstanding our role, we have allowed seeds of all types, both good and bad, to enter our inner garden.</p>
                </div>
              </div>              
                  ...
                  <div className="comment-body">
                    ...
                    <div className="comment-text">
                      ...
                      <div className="comment-metadata">
                        <a href="#" className="comment-date">July 17, 2017 at 12:48 pm</a>
                      </div>                      
            ...
            <div id="respond" className="comment-respond">
              ...
              <form id="form" className="comment-form" method="post" action="#">
                ...
                <p className="comment-form-submit">
                  <input type="submit" className="btn btn-lg btn-color btn-button" value="Post Comment" id="submit-message" />
                </p>
